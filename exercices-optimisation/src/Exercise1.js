...
class Exercise1 extends Component {
  ...
  _documentListener = (event) => {
    console.log('document click from exercise 1');
  ...
  componentDidMount() {
    console.log('componentDidMount from exercise 1');
    document.addEventListener('click', this._documentListener);
  }

  componentWillUnmount() {
    console.log('componentWillUnmount from exercise 1');
