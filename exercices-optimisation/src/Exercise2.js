...
function Exercise2() {
  ...
  useEffect(() => {
    console.log('useEffect from exercise 2');
    const _documentListener = (event) => {
      console.log('document click from exercise 2');
    ...
    document.addEventListener('click', _documentListener);
    return () => {
      console.log('cleanup from exercise 2');
      document.removeEventListener('click', _documentListener);
    }
  }, []);
